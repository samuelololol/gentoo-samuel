...
# This file is a clone from:
# http://ftp.twaren.net/local-distfiles/pigfoot/gentoo-portage/app-misc/screen/screen-4.0.3-r6.ebuild
...
#		"cjk? ( http://ftp.twaren.net/local-distfiles/pigfoot/gentoo-portage/distfiles/screen-4.0.3-uao-patch.tar.bz2 )"
...
IUSE="debug nethack pam selinux multiuser cjk"
